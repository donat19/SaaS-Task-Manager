const paths = {
  ...
  activity: <><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.5.5 0 0 1-.96 0L8.81 3.18a.5.5 0 0 0-.96 0L5.5 11.54A2 2 0 0 1 3.57 13H2"/></>,
  ...
  paperclip: <><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 17.99 8.84l-8.59 8.57a2 2 0 0 1-2.83-2.83l8.49-8.49"/></>,
  ...
  log: <><path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h7"/><path d="M3 9h18"/><path d="m17 22 5-5"/><path d="m17 17 5 5"/></>,
...
export default function Icon({ name, className = 'ic', size, style }) {
  const s = size ? { width: size, height: size, ...style } : style
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" style={s} aria-hidden="true">
      {paths[name]}
    </svg>
  )
}
