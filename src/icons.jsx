// Lucide-style stroke icons. Inline SVG so we can theme with currentColor.
const Icon = ({ name, className = "ic", size, style }) => {
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" style={s} aria-hidden="true">
      {paths[name]}
    </svg>
  );
};
